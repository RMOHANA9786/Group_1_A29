    ...
    return (
        <>
            <footer className="fadeInUp col-md-12">
                <a href="https://github.com/RMOHANA9786/Group_1_A29.git" className="button github"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="https://medium.com/@mohana9786142078" className="button btn-light medium">
            ...
            <h5 className="text-center copyright"> © Copyrights reserved by MOHANA</h5>
        </>
    )
}
