    ...
    return (
        <>
            <footer className="fadeInUp col-md-12">
                <a href="https://github.com/sowmiya-saravanan1/Group_A29_2" className="button github"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="https://medium.com/" className="button btn-light medium">
            ...
            <h5 className="text-center copyright"> © Copyrights reserved by Sowmiya</h5>
        </>
    )
}
